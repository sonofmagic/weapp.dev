...
export const siteCopy = {
  'zh-CN': {
    ...
    pricing: {
      ...
      exploreOpenSource: '先看开源项目',
      communityLine: '开源工具免费可用，不设文档墙或付费 Issue。',
      communityAction: '去看开源项目',
      shelfKicker: '01 / 现在可用',
      shelfTitle: '开源 Community，现在就能用',
      futureShelfTitle: '尚未开放的产品方向',
      futureShelfDescription: '这些不是当前可购买套餐。先看赞助与可交付服务；下面只记录建设方向。',
      planAvailable: '现在可用',
      planPlanned: '规划中',
      sponsorKicker: '01 / 开源赞助与分账',
      allocationHeading: '到账后怎么分',
      roadmapKicker: '06 / 建设中的能力',
      buildKicker: '云构建',
      servicesKicker: '02 / 实施服务',
      servicesFootnote: '服务只围绕工具链交付，不承接与产品无关的业务外包。服务收入连续两个月超过总收入 50% 时，将停止接收新单。',
      slaKicker: '03 / 支持边界',
      ...
      faq: [
        ...
        { question: '赞助收入会如何使用？', answer: '净额按 60% 核心维护、25% 贡献者基金、15% 周边开源拆分。贡献者基金按季发放，不足 ¥500 滚存。人工服务等产品收入不进入这个基金。' },
        { question: '贡献者计划是工资或兼职吗？', answer: '不是。这是开源感谢金，不构成雇佣或兼职，也不买断版权。完整规则见贡献者计划页。' },
        { question: '现在有付费产品套餐可以购买吗？', answer: '没有。当前只有开源赞助与按项目范围的人工服务，没有 Pro / Team / Enterprise 之类的付费套餐收款。' },
      ],
    ...
    project: {
      ...
      stars: 'GitHub Stars',
      readiness: '发布就绪度',
      readinessNote: '规划中的项目不展示下载与 Stars，避免用 0 假装热度。稳定发布后会恢复公开指标。',
      adjacentNote: '邻接项目：服务 Taro + Vite 场景，不是首页三层支柱（样式 / 构建 / 组件）之一。',
      futureDocs: '未来文档路径',
    ...
    contributors: {
      ...
      sections: [
        ...
        {
          title: '资金从哪来',
          body: '只拆已确认到账的开源赞助净额，包括个人 ¥20 / ¥200 / ¥1,000 和 Gold 企业合作。未来的 Pro、Team、迁移实施和模板 15% 作者分成走产品账，不进本基金。',
        },
        {
          title: '谁能领',
  ...
  'en': {
    ...
    pricing: {
      ...
      exploreOpenSource: 'Explore open source',
      ...
      shelfKicker: '01 / AVAILABLE NOW',
      shelfTitle: 'Open-source Community, available now',
      futureShelfTitle: 'Product directions not open yet',
      futureShelfDescription: 'These are not purchasable plans today. Review sponsorship and services first; the cards below only record direction.',
      planAvailable: 'AVAILABLE',
      planPlanned: 'PLANNED',
      sponsorKicker: '01 / SPONSORSHIP AND SPLITS',
      allocationHeading: 'How received funds are shared',
      roadmapKicker: '06 / ROADMAP',
      buildKicker: 'CLOUD BUILDS',
      servicesKicker: '02 / SERVICES',
      servicesFootnote: 'Services stay tied to the toolchain and do not become unrelated product outsourcing. New work pauses if services exceed 50% of total revenue for two consecutive months.',
      ...
      sponsorAllocation: 'Confirmed sponsorship is split net of payment fees: 60% core maintenance, 25% contributors fund, 15% nearby open source. If the quarterly fund is under ¥500, it rolls forward. Ledgers are published each quarter.',
      sponsorAllocationBuckets: [
        { share: '60%', name: 'Core maintenance', body: 'Maintainer time, testing, CI, domains, and the docs sites.' },
        { share: '25%', name: 'Contributors fund', body: 'Quarterly payouts for eligible work; up to 40% may be bounties.' },
      ...
      faq: [
        ...
        { question: 'How is sponsorship income used?', answer: 'Net receipts split 60% core maintenance, 25% contributors fund, and 15% nearby open source. The contributors fund pays quarterly and rolls forward under ¥500. Human-service revenue stays out of this fund.' },
        { question: 'Is the contributor program employment or contracting?', answer: 'No. It is an open-source thank-you, not a job or paid engagement, and it does not buy copyright. Full rules are on the contributor program page.' },
        { question: 'Are there paid product plans to buy today?', answer: 'No. Today there is only open-source sponsorship and scoped human services. There is no Pro / Team / Enterprise checkout.' },
      ],
    ...
    project: {
      ...
      readinessNote: 'Planned projects omit downloads and stars so zeros are never mistaken for traction. Public metrics return after a stable release.',
      adjacentNote: 'Adjacent project: for Taro + Vite workflows. It is not one of the homepage three-layer pillars (style / build / components).',
    ...
    contributors: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Only confirmed open-source sponsorship, net of payment fees, including the ¥20 / ¥200 / ¥1,000 personal tiers and Gold business partnerships. Future Pro, Team, implementation fees, and the 15% template author share stay on the product ledger.',
        },
        {
