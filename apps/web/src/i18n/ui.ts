...
export const siteCopy = {
  'zh-CN': {
    ...
    pricing: {
      ...
      shelfKicker: '01 / 产品货架',
      shelfTitle: '从一次试用，到一套可复现的交付',
      planAvailable: '现在可用',
      planPlanned: '规划中',
      sponsorKicker: '01A / 开源赞助',
      allocationHeading: '资金去向',
      roadmapKicker: '02 / 建设中的能力',
      buildKicker: '03 / 云构建',
      servicesKicker: '04 / 实施服务',
      servicesFootnote: '服务只围绕工具链交付，不承接与产品无关的业务外包。服务收入连续两个月超过总收入 50% 时，将停止接收新单。',
      slaKicker: '05 / 支持边界',
      boundaryKicker: '06 / 开源边界',
      faqKicker: '07 / FAQ',
      slaTier: '层级',
      slaChannel: '渠道',
      slaResponse: '响应',
  ...
  'en': {
    ...
    pricing: {
      ...
      shelfKicker: '01 / PRODUCT SHELF',
      shelfTitle: 'From one trial to a reproducible delivery path',
      planAvailable: 'AVAILABLE',
      planPlanned: 'PLANNED',
      sponsorKicker: '01A / OPEN-SOURCE SPONSORSHIP',
      allocationHeading: 'Where it goes',
      roadmapKicker: '02 / ROADMAP',
      buildKicker: '03 / CLOUD BUILDS',
      ...
      slaKicker: '05 / SUPPORT',
      boundaryKicker: '06 / OPEN-SOURCE BOUNDARY',
      faqKicker: '07 / FAQ',
      slaTier: 'Tier',
      slaChannel: 'Channel',
