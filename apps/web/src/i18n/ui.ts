...
export const siteCopy = {
  'zh-CN': {
    ...
    hero: {
      eyebrow: '为真实小程序工程而建',
      title: 'weapp.dev',
      description: '从 Tailwind CSS 样式到 Vite 构建，用一套开放工具链交付小程序。',
      primary: '查看项目',
      secondary: '查看 GitHub',
      visualLabel: 'weapp.dev Build Lens 展示源码、样式、构建与多平台输出',
    },
    about: {
      eyebrow: '构建链路',
      title: '保留你的写法，升级交付链路',
      description: '工具分别接管样式转换与工程构建，让现有小程序可以渐进接入，也让新项目拥有现代开发体验。',
      items: [
        { title: '编写', body: '继续使用原生小程序、Vue SFC 或跨端框架，保留团队熟悉的页面与组件边界。' },
        { title: '转换', body: '让 weapp-tailwindcss 处理样式与类名，让 weapp-vite 处理依赖、路由和构建生命周期。' },
        { title: '交付', body: '显式选择目标平台，在真实运行时中调试、截图、对比并发布可复现产物。' },
      ],
    },
    projects: {
      eyebrow: '工具栈',
      title: '两项工具，各自解决一类难题',
      description: '按需独立采用，也可以组合成从样式输入到多平台产物的完整工程。',
      documentation: '阅读文档',
      details: '项目详情',
      weeklyDownloads: '周下载',
      stars: 'Stars',
  ...
  'en': {
    ...
    hero: {
      ...
      title: 'weapp.dev',
      description: 'Ship mini-apps with one open toolchain, from Tailwind CSS styling to Vite-powered builds.',
    ...
    about: {
      ...
      description: 'Separate tools own style transforms and project builds, so existing mini-apps can migrate gradually and new projects start with modern DX.',
      items: [
        ...
        { title: 'Transform', body: 'Let weapp-tailwindcss own styles and classes while weapp-vite owns dependencies, routes, and the build lifecycle.' },
        { title: 'Deliver', body: 'Choose one target explicitly, then debug, capture, compare, and publish reproducible output in the real runtime.' },
      ],
    },
    projects: {
      eyebrow: 'The stack',
      title: 'Two tools. Two clear responsibilities.',
      description: 'Adopt either one on its own, or combine them from styling input to multi-platform output.',
