  ...
  'zh-CN': {
    ...
    commercial: {
      ...
      cards: [
        ...
        { title: '赞助开源', body: '用固定档次支持维护、文档、测试和小程序周边项目。' },
      ],
      pricing: '交付与赞助',
      trial: '支持开源',
      services: '查看可交付服务',
    ...
    pricing: {
      ...
      sponsorTiers: [
        { name: '个人支持', price: '¥19', cadence: '/ 月', body: '从一次小额长期支持开始。' },
        { name: '项目支持', price: '¥99', cadence: '/ 月', body: '为工具链维护和文档投入一份稳定预算。' },
        { name: '生态共建', price: '¥499', cadence: '/ 月', body: '支持更大范围的测试、基础设施和社区协作。' },
      ],
      sponsorAction: '申请赞助方式',
      sponsorAllocation: '赞助收入的 20% 会用于赞助小程序周边开源项目；其余用于 weapp.dev 的维护、文档、测试、构建基础设施和社区运营。后续按月或按季度公布支持去向。',
      sponsorNote: '赞助不包含技术支持、模板源码、云构建额度或其他商业权益。',
      roadmapTitle: '建设中的能力',
  ...
  'en': {
    ...
    commercial: {
      ...
      cards: [
        ...
        { title: 'Sponsor open source', body: 'Support maintenance, documentation, testing, and mini-app ecosystem projects with a recurring contribution.' },
      ],
    ...
    pricing: {
      ...
      sponsorTiers: [
        { name: 'Personal support', price: '¥19', cadence: '/ month', body: 'Start with a small recurring contribution.' },
        { name: 'Project support', price: '¥99', cadence: '/ month', body: 'Fund a steadier slice of toolchain maintenance and documentation.' },
        { name: 'Ecosystem partner', price: '¥499', cadence: '/ month', body: 'Support broader testing, infrastructure, and community work.' },
      ],
      ...
      sponsorNote: 'Sponsorship does not include technical support, template source, cloud-build minutes, or other commercial benefits.',
