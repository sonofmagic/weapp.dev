...
export const siteCopy = {
  'zh-CN': {
    ...
    pricing: {
      ...
      faq: [
        ...
        { question: '赞助收入会如何使用？', answer: '净额按 60% 核心维护、25% 贡献者基金、15% 周边开源拆分。贡献者基金按季发放，不足 ¥500 滚存。未来的 Pro、Team 和实施收入不进入这个基金。' },
  ...
  'en': {
    ...
    pricing: {
      ...
      planPlanned: 'PLANNED',
      sponsorKicker: '02 / OPEN-SOURCE SPONSORSHIP',
      allocationHeading: 'Where it goes',
      ...
      slaKicker: '04 / SUPPORT',
      boundaryKicker: '05 / OPEN-SOURCE BOUNDARY',
      faqKicker: '07 / FAQ',
      slaTier: 'Tier',
      slaChannel: 'Channel',
      ...
      faq: [
        ...
        { question: 'How is sponsorship income used?', answer: 'Net receipts split 60% core maintenance, 25% contributors fund, and 15% nearby open source. The contributors fund pays quarterly and rolls forward under ¥500. Future Pro, Team, and implementation revenue stay out of this fund.' },
